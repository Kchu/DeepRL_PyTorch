...
PRED_PATH = './data/model/C51_pred_net.pkl'
TARGET_PATH = './data/model/C51_target_net.pkl'
RESULT_PATH = './data/plots/C51_result.pkl'
...
## plot the figure
# plt.plot(range(len(result)), result, label="C51")
# plt.legend()
# plt.tight_layout()
# plt.show()